...
const miscObject = {
    ...
    merge(original, ...sources) {
        original = miscObject.clone(original);
    ...
    hasByKeys(target, ...keys) {
        ...
        const key = keys.pop();
        const pointer = miscObject.pointByKeys(target, false, ...keys);
    ...
    setByKeys(target, value, ...keys) {        
        ...
        const key = keys.pop();
        const pointer = miscObject.pointByKeys(target, true, ...keys);
